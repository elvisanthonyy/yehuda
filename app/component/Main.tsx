        ...
        >
          ...
          <div className="mt-[32px] md:w-[60%] md:justify-center md:border md:border-primary-5 bg-[#333333] md:h-full md:mt-0 md:px-[40px] rounded-[12px] md:order-1 flex flex-col w-full">
            <div className="flex flex-col gap-3">
              ...
              <div className="w-full rounded-[32px] border border-secondary-5 bg-[#38372E] my-1 md:text-[16px] px-6 py-[8px] md:my-[12px] text-[14px] md:py-[8px] text-left border-primary-2 text-secondary-2">
                A Music Producer
              </div>
