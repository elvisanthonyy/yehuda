...
const MusicPlayer = ({ beat, setIsMusiPlayerOpen }: ChildProps) => {
  ...
  return (
    <div className="w-full  shadow-[0_-6px_20px_rgba(0,0,0,0.15)] border-t border-yehuda-lightgray z-71 fixed bottom-0 left-0 py-3 min-h-44 overflow-hidden mt-5">
